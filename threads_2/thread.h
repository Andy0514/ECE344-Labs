...
// This function deallocates memory associated with all exited threads
void thread_exit_cleanup();

// This function exits a thread. It's run by killed threads instead of their 
// normal functions. 
void exit_this_thread(void* nothing);
